...
export default function PrivacyConsent({ checkbox = false }) {
  return <section className="privacy-consent-box" aria-labelledby={checkbox ? 'signup-privacy-title' : undefined}>
    ...
    <p>운영자 인터뷰 답변과 생성된 소개·FAQ 초안은 공용 검사 캐시에 저장하지 않습니다. AI 발견 검사에 입력한 소비자 질문은 검색 답변 생성을 위해 Google Gemini에 전달되므로 개인정보나 비공개 정보를 입력하지 마세요.</p>
    <p>회원은 계정 화면에서 직접 탈퇴할 수 있습니다. 탈퇴하면 계정에 연결된 로그인, 저장 사이트, 검사 이력, 이용 기록, 개선 체크리스트와 공유 보고서가 삭제됩니다.</p>
