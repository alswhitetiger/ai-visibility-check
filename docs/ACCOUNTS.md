...
- 2026-09-09 Workers 실서버에서 기존 이메일 가입·로그인·보안 쿠키·사이트 저장과 삭제·실제 페이지 검사·이력 저장·한도 20→19 차감·로그아웃을 검증했다. 테스트 계정은 제거했다. 2026-09-15 회원·검사·공유·삭제·AI 입력 분리를 포함한 자동 테스트 54개가 통과했다.
